...
% pozymiai is celio masyvo perkeliami i matrica
% take the features from cell-type variable and save into a matrix-type variable
P = cell2mat(pozymiai_tinklo_mokymui);
% sukuriama teisingo atsakymo matrica: 11 raidziu, 8 eilutes mokymui
...
% skaièiuojamas tinklo isëjimas nezinomiems pozymiams
...
% KIEK SLUOKSNIU, KIEKVIENAM SLUOKSNY KO KIEK YRA
% 
